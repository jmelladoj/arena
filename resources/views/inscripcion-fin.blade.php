...
<body>
        <h2><b>YA ERES PARTE DE TORNEO ARENA 2019</b></h2>

        <p style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px">
            Hemos validado tu inscripción en la categoría <b> {{ $atleta->categoria->nombre_categoria . ' ' . $atleta->categoria->nombre }} </b> y ya eres parte de los atletas que competirán este 4 y 5 de mayo en el COLISEO MONUMENTAL LA TORTUGA DE TALCAHUANO.
