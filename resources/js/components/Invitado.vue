        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Invitados</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <button type="button" @click="abrirModal('atleta','registrar')" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Agregar Atleta</button>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="table-responsive">
                                        <b-container fluid>
                                            ...
                                            <template slot="cupos" slot-scope="row">
                                                {{ row.item.cupos / row.item.Atleta }}
                                            </template>

                                            <template slot="inscritos" slot-scope="row">
                                                {{ row.item.cantidad_count / row.item.Atleta }}
                                            </template>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <div class="form-group m-b-20">
                                            ...
                                            <input type="text" class="form-control" v-model="run" v-rut required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group m-b-20">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <div class="form-group m-b-20">
                                            ...
                                            <select class="form-control p-0" v-model="categoria_id" required>
                                                <option v-for="categoria in arrayCategoria" :key="categoria.id" :value="categoria.id" v-text="categoria.nombre_categoria + ' ' + categoria.nombre"></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group m-b-20">
                                            ...
                                            <select class="form-control p-0" v-model="polera_id" required>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarAtleta()">Guardar</button>
    ...
    export default {
        ...
        methods : {
            ...
            registrarAtleta(){
                ...
                axios.post('/atleta/registrarInvitado',{
                    'run': this.run,
                    'nombre': this.nombre,
                    'correo': this.correo,
            ...
            actualizarAtleta(){
                ...
                axios.post('/atleta/actualizarInvitado',{
                    'run': this.run,
                    'nombre': this.nombre,
                    'correo': this.correo,
                    'categoria_id': this.categoria_id,
            ...
            validarAtleta(){
                ...
                if (!this.nombre) this.errores.push("Debes ingresar un nombre");
                if (!this.run) this.errores.push("Debes ingresar un run");
                if (!this.polera_id) this.errores.push("Debes seleccionar una polera");
                if (!this.correo) this.errores.push("Debes ingresar un mail");
                if (!this.correo.includes('.') || !this.correo.includes('@')) this.errores.push("Debes ingresar un mail valido");
            ...
            statusAtleta(estado){
                ...
                if(estado == 1){
                    ...
                    this.estados.push('Registro actualizado exitosamente');
                }
                ...
                switch(modelo){
                    case "atleta":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar Atleta';
                                this.run = '';
                                this.nombre = '';
                                this.correo = '';
                                this.polera_id = 0;
