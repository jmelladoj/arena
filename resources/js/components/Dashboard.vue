                            ...
                            <div class="col-md-12">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        ...
                                        <p class="text-muted">INSCRIPCIONES</p>
                                    </div>
                                    <div class="ml-auto">
                                        <h2 class="counter text-cyan" v-text="cantidad_atletas"></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-md-12">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        ...
                                        <p class="text-muted">DINERO RECAUDADO</p>
                                    </div>
                                    <div class="ml-auto">
                                        <h2 class="counter text-success" v-text="'$' + recaudado.toLocaleString()"></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
        ...
        methods : {
            ...
            listarAtleta (){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.recaudado = respuesta.recaudado;
                    me.cantidad_atletas = respuesta.cantidad_atletas;
