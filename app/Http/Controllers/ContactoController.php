...
class ContactoController extends Controller
{
    ...
    public function contacto(Request $request){
        ...
        if(!isset($request->userName) || !isset($request->userEmail) || !isset($request->userMessage))
        {
        ...
        $user_Name        = filter_var($request->userName, FILTER_SANITIZE_STRING);
        $user_Email       = filter_var($request->userEmail, FILTER_SANITIZE_EMAIL);
        $user_Message     = filter_var($request->userMessage, FILTER_SANITIZE_STRING);
